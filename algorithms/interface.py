...
def change_color1(choice):
    ...
    if(choice=='Machine'):
        dropdown1.config(bg="blue")
    elif(choice=='Path'):
        dropdown1.config(bg="grey")
    elif(choice=='Wall'):
        dropdown1.config(bg="white")
variable1 = StringVar()
...
def change_color2(choice):
    ...
    if(choice=='Machine'):
        dropdown2.config(bg="blue")
    elif(choice=='Path'):
        dropdown2.config(bg="grey")
    elif(choice=='Wall'):
...
def change_color3(choice):
    ...
    if(choice=='Machine'):
        dropdown3.config(bg="blue")
    elif(choice=='Path'):
        dropdown3.config(bg="grey")
    elif(choice=='Wall'):
        dropdown3.config(bg="white")
variable3 = StringVar()
...
def change_color4(choice):
    ...
    if(choice=='Machine'):
        dropdown4.config(bg="blue")
    elif(choice=='Path'):
        dropdown4.config(bg="grey")
    elif(choice=='Wall'):
        dropdown4.config(bg="white")
variable4 = StringVar()
...
def change_color5(choice):
    ...
    if(choice=='Machine'):
        dropdown5.config(bg="blue")
    elif(choice=='Path'):
        dropdown5.config(bg="grey")
    elif(choice=='Wall'):
        dropdown5.config(bg="white")
variable5 = StringVar()
...
def change_color6(choice):
    ...
    if(choice=='Machine'):
        dropdown6.config(bg="blue")
    elif(choice=='Path'):
        dropdown6.config(bg="grey")
    elif(choice=='Wall'):
        dropdown6.config(bg="white")
variable6 = StringVar()
...
def change_color7(choice):
    ...
    if(choice=='Machine'):
        dropdown7.config(bg="blue")
    elif(choice=='Path'):
        dropdown7.config(bg="grey")
    elif(choice=='Wall'):
        dropdown7.config(bg="white")
variable7 = StringVar()
...
def change_color8(choice):
    ...
    if(choice=='Machine'):
        dropdown8.config(bg="blue")
    elif(choice=='Path'):
        dropdown8.config(bg="grey")
    elif(choice=='Wall'):
        dropdown8.config(bg="white")
variable8 = StringVar()
...
def change_color9(choice):
    ...
    if(choice=='Machine'):
        dropdown9.config(bg="blue")
    elif(choice=='Path'):
        dropdown9.config(bg="grey")
    elif(choice=='Wall'):
        dropdown9.config(bg="white")
variable9 = StringVar()
...
def change_color10(choice):
    ...
    if(choice=='Machine'):
        dropdown10.config(bg="blue")
    elif(choice=='Path'):
        dropdown10.config(bg="grey")
    elif(choice=='Wall'):
        dropdown10.config(bg="white")
...
def change_color11(choice):
    ...
    if(choice=='Machine'):
        dropdown11.config(bg="blue")
    elif(choice=='Path'):
        dropdown11.config(bg="grey")
    elif(choice=='Wall'):
        dropdown11.config(bg="white")
...
def change_color12(choice):
    ...
    if(choice=='Machine'):
        dropdown12.config(bg="blue")
    elif(choice=='Path'):
        dropdown12.config(bg="grey")
    elif(choice=='Wall'):
        dropdown12.config(bg="white")
...
def change_color13(choice):
    ...
    if(choice=='Machine'):
        dropdown13.config(bg="blue")
    elif(choice=='Path'):
        dropdown13.config(bg="grey")
    elif(choice=='Wall'):
        dropdown13.config(bg="white")
...
def change_color14(choice):
    ...
    if(choice=='Machine'):
        dropdown14.config(bg="blue")
    elif(choice=='Path'):
        dropdown14.config(bg="grey")
    elif(choice=='Wall'):
        dropdown14.config(bg="white")
...
def change_color15(choice):
    ...
    if(choice=='Machine'):
        dropdown15.config(bg="blue")
    elif(choice=='Path'):
        dropdown15.config(bg="grey")
    elif(choice=='Wall'):
        dropdown15.config(bg="white")
...
def change_color16(choice):
    ...
    if(choice=='Machine'):
        dropdown16.config(bg="blue")
    elif(choice=='Path'):
        dropdown16.config(bg="grey")
    elif(choice=='Wall'):
        dropdown16.config(bg="white")
...
def change_color17(choice):
    ...
    if(choice=='Machine'):
        dropdown17.config(bg="blue")
    elif(choice=='Path'):
        dropdown17.config(bg="grey")
    elif(choice=='Wall'):
        dropdown17.config(bg="white")
...
def change_color18(choice):
    ...
    if(choice=='Machine'):
        dropdown18.config(bg="blue")
    elif(choice=='Path'):
        dropdown18.config(bg="grey")
    elif(choice=='Wall'):
        dropdown18.config(bg="white")
...
def change_color19(choice):
    ...
    if(choice=='Machine'):
        dropdown19.config(bg="blue")
    elif(choice=='Path'):
        dropdown19.config(bg="grey")
    elif(choice=='Wall'):
        dropdown19.config(bg="white")
...
def change_color20(choice):
    ...
    if(choice=='Machine'):
        dropdown20.config(bg="blue")
    elif(choice=='Path'):
        dropdown20.config(bg="grey")
    elif(choice=='Wall'):
        dropdown20.config(bg="white")
...
def change_color21(choice):
    ...
    if(choice=='Machine'):
        dropdown21.config(bg="blue")
    elif(choice=='Path'):
        dropdown21.config(bg="grey")
    elif(choice=='Wall'):
        dropdown21.config(bg="white")
...
def change_color22(choice):
    ...
    if(choice=='Machine'):
        dropdown22.config(bg="blue")
    elif(choice=='Path'):
        dropdown22.config(bg="grey")
    elif(choice=='Wall'):
        dropdown22.config(bg="white")
...
def change_color23(choice):
    ...
    if(choice=='Machine'):
        dropdown23.config(bg="blue")
    elif(choice=='Path'):
        dropdown23.config(bg="grey")
    elif(choice=='Wall'):
        dropdown23.config(bg="white")
...
def change_color24(choice):
    ...
    if(choice=='Machine'):
        dropdown24.config(bg="blue")
    elif(choice=='Path'):
        dropdown24.config(bg="grey")
    elif(choice=='Wall'):
        dropdown24.config(bg="white")
...
def change_color25(choice):
    ...
    if(choice=='Machine'):
        dropdown25.config(bg="blue")
    elif(choice=='Path'):
        dropdown25.config(bg="grey")
    elif(choice=='Wall'):
        dropdown25.config(bg="white")
